...
So let $(a_1 : ... : a_n) \in Z^+(\I^+(V) \cap K[x_1, ..., x_n])$.
With $\I^+(V) = \langle f_1, ..., f_m \rangle$ it suffices to show that 
\begin{equation*}
    J = \langle f_1(x, a_1, ..., a_n), ... f_m(x, a_1, ..., a_n) \rangle
\end{equation*}
is a proper subset of $K[x]$.
Consider
\begin{align*}
    \phi: P_{l - \deg f_1} \times ... \times P_{l - \deg f_m} &\to P \\
    (g_1, ..., g_m) &\mapsto \sum_i g_i(1, a_1, ..., a_n) f_i(1, a_1, ..., a_n) x^l
\end{align*}
We see that $\mathrm{im}\phi = J_l$. Hence, assume that $\mathrm{ev}_{a_1, ..., a_m} \circ \phi$ is surjective.
Let $g_1, ..., g_m$ such that $\phi(g_1, ... g_m) = x^l$.
Then $f = \sum_i g_i f_i(x, y_1, ..., y_n) \in \I^+(V) \cap K[y_1, ..., y_n]$. We get a contradiction as by assumption, $f(a_1, ..., a_n) = 0 \neq 1$.
