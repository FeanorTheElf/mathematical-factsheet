...
Let $(a_n)_n$ be a sequence in $\C$ with $|a_n| \leq n^{o(1)}$. Then
\begin{equation*}
...
\begin{align*}
    ...
    &= -\frac 1 2 + \frac {s + 1} 2 \int_1^\infty \frac t {t^{s + 2}} dt - \frac {s + 2} 2 \int_1^\infty \frac {\{t\} + \{t\}^2} {t^{s + 2}} dt \\
    &= -\frac 1 2 + \frac {s + 1} {2s} - \frac {s + 2} 2 \int_1^\infty \frac {\{t\} + \{t\}^2} {t^{s + 2}} dt
\end{align*}
and so
\begin{equation*}
    \sum_{n \geq 1} \frac 1 {n^s} = \frac 1 {s - 1} + \frac 1 2 + \frac {(s + 2)s} 2 \int_1^\infty \frac {\{t\} + \{t\}^2} {t^{s + 2}} dt
\end{equation*}
