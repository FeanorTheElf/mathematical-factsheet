...
\paragraph{Proof idea} Call an $\mathcal{L}(\mathcal{M})$-formula ``large'', if it has uncountably many realizations.
...
Now consider a constructible elementary prime extension $\mathcal{N}$ of $|\mathcal{M}| \cup b$, where $b$ realizes $p$ (in some elementary extension of $\mathcal{M}$).
