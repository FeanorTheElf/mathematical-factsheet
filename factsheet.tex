...
a ring isomorphism $( (\Z/p^\alpha\Z) \ / \ ([p^{\alpha - 1}]) ) \cong \Z/p^{\alpha - 1}\Z$, which is cyclic by the induction hypothesis. Therefore, $G / \mathrm{im}(f) \cong \mathrm{ker}(f)$ yields:
\begin{equation}
